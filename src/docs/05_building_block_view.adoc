...
[role="arc42help"]
 ...
 The purpose of this box is that the user is able to log in with his own account that allows him to obtain an experience of the application as personalized as possible.
